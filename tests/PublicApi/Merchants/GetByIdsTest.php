 ...
 * @internal
 */
#[TestDox('Получение информации о торговых точках (фильтр по внутренним идентификаторам торговых точек)')]
final class GetByIdsTest extends TestCase
{
    ...
    public function testSucceed(): void
    {
        ...
        $result = $loymax->publicApi()->merchants()->getByIds();
    ...
    #[TestDox('Успешный результат с фильтром по внутренним идентификаторам торговых точек')]
