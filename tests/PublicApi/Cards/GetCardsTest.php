...
use Studio15\Loymax\PublicApi\Cards\MockResponse\GetCardsResponse;
...
final class GetCardsTest extends TestCase
{
    ...
    {
        $loymax = $this->createLoymaxClient([GetCardsResponse::getResponse()]);
        ...
        self::assertSame('Loymax.Mobile.Contract.Models.Cards.VirtualCardInfo, Loymax.Mobile.Contract', $result[0]->type);
        ...
        self::assertSame('Loymax.Common.Contract.Model.Cards.CardCategoryInfo, Loymax.Common.Contract', $result[0]->cardCategory->type);
