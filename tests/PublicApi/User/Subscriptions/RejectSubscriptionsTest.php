 ...
 * @internal
 */
#[TestDox('Запрос на отказ от всех типов подписки')]
final class RejectSubscriptionsTest extends TestCase
{
    ...
    public function testSuccess(): void
    {
        ...
        $loymax->publicApi('validAccessToken')->user()->rejectSubscriptions();
    }
    ...
    public function testUnauthorized(): void
    {
        ...
        $loymax = $this->createLoymaxClient([$mockResponse]);
        $loymax->publicApi()->user()->rejectSubscriptions();
    }
