...
final class GetStatusTest extends TestCase
{
    ...
    public function testSucceed(): void
    {
        ...
        self::assertSame('Дегустатор', $result[0]->currentStatus->name);
        self::assertSame(99.0, $result[0]->currentStatus->threshold);
        self::assertSame('Начисление бонусов 2% от суммы чека', $result[0]->currentStatus->description);
        self::assertSame('2%', $result[0]->currentStatus->preferences);
        self::assertNull($result[0]->currentStatus->preferencesAdditional);
